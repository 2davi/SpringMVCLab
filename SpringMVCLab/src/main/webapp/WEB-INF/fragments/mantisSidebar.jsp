...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        <li class="pc-item">
          <a href="${pageContext.request.contextPath }/resources/dist/dashboard/index.html" class="pc-link">
        ...
        <li class="pc-item">
          <a href="${pageContext.request.contextPath }/prod/prodList.do" class="pc-link">
            ...
            <span class="pc-mtext">Product List</span>
          </a>
        </li>
        <li class="pc-item">
        ...
        <li class="pc-item">
          <a href="${pageContext.request.contextPath }/buyer/buyerList.do" class="pc-link">
            <span class="pc-micon"><i class="ti ti-typography"></i></span>
            <span class="pc-mtext">Buyer List</span>
          </a>
        </li>
        <li class="pc-item">
